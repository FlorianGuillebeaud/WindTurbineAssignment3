...
function [Vrel_y, Vrel_z] = velocity_compute_turb_2(u,j, r, H, Ls, Wy, Wz, Theta_wing1, Theta_wing2, Theta_wing3,omega,V_0, Theta_cone, Uy_dot, Uz_dot)
        
global a_12 a_21 a_34 x
        rt = [H 0 0] ; 
        rs = a_21*[0 0 -Ls]' ;
